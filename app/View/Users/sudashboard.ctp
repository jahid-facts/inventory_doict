    ...
    <div class="col-md-12">
		...
		<div class="row">	
			<div class="col-md-4">
				...
				<div class="my_block my_color_07">
					...
					<p class="my_link_01"> Rejected Products Requisition </p>
            ...
            <div class="col-md-4">
                <a href="<?php echo $this->webroot;?>deliveries"> 
                <div class="my_block my_color_05">
						...
						<p class="my_badges btn btn-default"><?php echo $deliveredecountss;?> <?php //echo $deliveredecount;?> </p>
                </div>
                </a>
            </div>
            ...
            <div class="col-md-4">            
                ...
                <div class="my_block my_color_06">
                    <img src="<?php echo $this->webroot; ?>img/my_icons/pro_stock_01.png" width="50px" /> <br>
                    <p class="my_link_01"> Products Stock </p>
                </div>
               </a>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <div class="my_block my_color_08">
                        <img src="<?php echo $this->webroot; ?>img/my_icons/cal1.png" width="50px" /> <br>
                        <p class="my_link_01" > Date wise Products Stock </p>
                </div>
                </a>
            </div> 
