...
<div class="payments form">
	...
	<div class="panel panel-primary" style="margin-top: 20px;">
        <div class="panel-heading">
          <h3 class="panel-title"><a title="Back" href="<?php echo $this->webroot?>users/superusers">Super Admin</a><?php echo '/Edit';?></h3>
        </div>
        <div class="panel-body"> 
            <div class="col-sm-10 col-sm-offset-1">  
				...
				<div class="col-sm-6 pr"> 
                    ...
                    <?php echo $this->Form->input('division_id',array('onChange'=>'getDistrictId(this.value);','label'=>false,'div'=>false,'class'=>'form-control border-input','empty'=>'Select Division','disabled'=>true,'required'=>true));?> 
                </div>
                <div class="col-sm-6 pl"> 
                    <label>District</label> 
                    <?php echo $this->Form->input('district_id',array('type'=>'select','label'=>false,'div'=>false,'class'=>'form-control border-input district_option','options'=>$districts,'empty'=>'Select District','disabled'=>true,'required'=>true));?> 
                    <div id="district"></div>
                </div>
				...
				<div class="col-sm-6 pl"> 
					...
					<?php echo $this->Form->input('serial',array('type'=>'hidden','class'=>'form-control','label'=>false, 'value'=>$val,));?>
				<div class="col-sm-6 pr"> 
			        <label>Photo</label>  
