...
<?php echo $this->Form->create('Deliverydetail'); ?>
	<fieldset>
		<legend><?php echo __('Edit Deliverydetail'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Deliverydetail.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Deliverydetail.id'))); ?></li>
