    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"> 
                <?php echo __('Settings List'); ?>
                <span class="add-span">
                    <?php echo $this->Html->link(__('<span class="fa fa-plus"></span> Add Settings'), array('action' => 'add'),array('class'=>'btn btn-default btn-rounded btn-condensed btn-sm','escape'=>false)); ?>
                </span> 
            </h3>
        </div>
            ...
            <div class="col-sm-8 col-sm-offset-2">
                ...
                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover thla" id="dataTables-example">
                    ...
                    <tr>
                        ...
                        <td><?php echo h($setting['Setting']['companyname']); ?>&nbsp;</td>
                        <td><?php echo h($setting['Setting']['metadescription']); ?>&nbsp;</td>
                        <td><?php echo h($setting['Setting']['email']); ?>&nbsp;</td>
                        <td class="actions"> 
                            <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit', $setting['Setting']['id']),array('escape' =>false)); ?> 
                        </td>
                    </tr>
                    <?php $i++; endforeach; ?>
                </table>
