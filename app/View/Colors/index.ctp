    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"> 
                <?php echo __('Colors List'); ?> 
                <span class="add-span">
                    <?php echo $this->Html->link(__('<span class="fa fa-plus"></span> Add Colors'), array('action' => 'add'),array('class'=>'btn btn-default btn-rounded btn-condensed btn-sm','escape'=>false)); ?>
                </span>
            </h3>
        </div>
                ...
                <?php echo $this->Session->flash(); ?>  
                    <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover thla" id="dataTables-example">
                        <tr>
                            ...
                            <th style="width: 65%;"><?php echo $this->Paginator->sort('name'); ?></th>
                            <th style="width: 20%;" class="actions"><?php echo __('Actions'); ?></th>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="actions"> 
                                &nbsp;&nbsp; <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil"></i>'), array('action' => 'edit', $color['Color']['id']),array('escape' =>false)); ?> 
                            </td>
                        </tr>
                        <?php $i++; endforeach; ?>
                    </table>
