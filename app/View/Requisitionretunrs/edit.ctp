...
<?php echo $this->Form->create('Requisitionretunr'); ?>
	<fieldset>
		<legend><?php echo __('Edit Requisitionretunr'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Requisitionretunr.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Requisitionretunr.id'))); ?></li>
