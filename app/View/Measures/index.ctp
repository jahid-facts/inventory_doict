    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"> 
                <?php echo __('Measure List'); ?> 
                <span class="add-span">
                    <?php echo $this->Html->link(__('<span class="fa fa-plus"></span> Add Measure'), array('action' => 'add'),array('class'=>'btn btn-default btn-rounded btn-condensed btn-sm','escape'=>false)); ?>
                </span>
            </h3>
        </div>
            ...
            <div class="col-sm-4 col-sm-offset-4">
                ...
                <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover thla" id="dataTables-example">
                    ...
                    <tr>
						...
						<td><?php echo h($measure['Measure']['name']); ?>&nbsp;</td>
						<td class="actions"> 
							&nbsp;&nbsp;&nbsp; <?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil" title="Edit Measure"></i>'), array('action' => 'edit', $measure['Measure']['id']),array('escape' =>false)); ?> 
