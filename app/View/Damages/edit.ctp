...
<?php echo $this->Form->create('Damage'); ?>
	<fieldset>
		<legend><?php echo __('Edit Damage'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('quantity');
		echo $this->Form->input('product_id');
		echo $this->Form->input('measure_id');
		echo $this->Form->input('dnumber');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Damage.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Damage.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Damages'), array('action' => 'index')); ?></li>
