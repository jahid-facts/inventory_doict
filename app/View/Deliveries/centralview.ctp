...
<div class="col-sm-10 col-sm-offset-1">			
    <div class="row">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <h6 class="f-spans"><?php echo $users[$deliveryviews[0]['Requisition']['approvedBy']]; ?></h6>
        ...
        <div class="col-xs-12" style="text-align: center;">
            <?php echo $this->Html->link(__('&nbsp;Back&nbsp;'), array('controller' => 'requisitions','action' => 'particularuser',$iduser,$iddist),array('class'=>'btn btn-warning','escape' =>false)); ?> 
