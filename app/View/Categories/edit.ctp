...
<div class="col-sm-6 col-sm-offset-3">
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3><?php echo __('Edit Main Category'); ?></h3>
        </div>
        <div class="panel-body">
            ...
            <?php echo $this->Form->create('Category',array('type'=>'file','class'=>'form-horizontal'));
                  ...
                  echo $this->Form->input('cccode',array('type'=>'hidden','value'=>$this->request->data['Category']['cCode']));

            ?>
            <div class="col-sm-5">
                <div class="form-group has-feedback" > 
                    <label>Category Code</label> 
                    <?php echo $this->Form->input('cCode',array('type'=>'text','class'=>'form-control','label'=>false,'onkeyup'=>'codeVerify(this.value);'));?> 
