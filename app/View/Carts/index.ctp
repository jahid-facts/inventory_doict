<div class="carts index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('cdate'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($cart['Cart']['stock']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($cart['Cart']['cdate']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $cart['Cart']['id']), array(), __('Are you sure you want to delete # %s?', $cart['Cart']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
