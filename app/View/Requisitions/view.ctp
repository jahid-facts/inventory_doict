...
<div class="col-sm-12" style="overflow-x: auto;"> 
	...
	<?php 
        if($currentUser['role_id'] ==1){
            if($this->params->pass[1]=='received' ){
            ...
            }elseif($this->params->pass[1]=='approview' ){
                echo $this->Html->link($this->Html->tag('i', '', array('class' => 'fa fa-mail-reply-all')).' Back', array('controller' => 'requisitions', 'action' => 'requisitionapprove'), array('class'=>'btn btn-success','escape'=>false));
            }
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               <form action="" method="POST">  
                            ...
                            <table class="table table-bordered txtcen">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        if($requisitiondetail['Requisitiondetail']['status']==2){
                                    ?>
                    ...
                    <!-- <div class="my-space-5"></div> 
                    <div class="row">
                        <div class="col-xs-12 my-right-align">
                                                                      
                            <?php if($currentUser['role_id']==1){?>
                            <?php  $rejectid=$requisition['Requisition']['id'] ?>
                                <?php if($requisition['Requisition']['status']!=2){?>
                                <hr>
                                <?php 
                                    echo $this->Html->link(__('Approve'),'javascript:void(0);', array('type'=>'submit','class'=>'btn btn-success ap','onClick'=>"getStatusApprove($rejectid);",'label' => false, 'div' => false));
                                ?>
                                <?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $requisition['Requisition']['id']),array('class'=>'btn btn-info ed')); ?>
                   
                                <?php 
                                    echo $this->Html->link(__('Reject'),'javascript:void(0);', array('class' =>'btn btn-danger','style'=>'float:right;','onClick'=>"getStatusReject($rejectid);"));
                                }
                            }?>
