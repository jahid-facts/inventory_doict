...
<div class="user index">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
          <h3 class="panel-title"> <?php echo __('Requisition Received'); ?> </h3>
        </div>
                            ...
                            <tr>
                                ...
                                <td class="actions" style="text-align: center;">
                                    ...
                                    <?php if($currentUser['role_id'] ==2){?>
                                        <?php echo $this->Html->link(__('<span class="fa fa-location-arrow"></span> Prepared delivery order'),array('action' => 'delivery', $requisition['Requisition']['id'],'receivedd'),array('class'=>'btn btn-info btn-sm','escape' =>false)); ?>

                                        <?php }?>
                                        <?php if($currentUser['role_id'] !=2){?>
                                        <?php echo $this->Html->link(__('<i class="fa fa-eye" title="View Requisition"></i>'), array('action' => 'viewr', $requisition['Requisition']['id'], $requisition['Requisition']['user_id'],'receivedd'),array('escape' =>false)); ?>
                                        <?php }?> 
                                </td>
