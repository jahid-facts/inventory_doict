    ...
    <div class="panel panel-primary">
        <div class="panel-heading">
            <h3 class="panel-title"> 
                <?php echo __('Suppliers List'); ?> 
                <span class="add-span">
                    <?php echo $this->Html->link(__('<span class="fa fa-plus"></span> Add Supplier'), array('action' => 'add'),array('class'=>'btn btn-default btn-rounded btn-condensed btn-sm','escape'=>false)); ?>
                </span>
            </h3>
        </div>
            ...
            <div class="table-responsive">
		        <table cellpadding="0" cellspacing="0" class="table table-striped table-bordered table-hover thla" id="dataTables-example">
    			    <tr>
            			...
            			<th><?php echo $this->Paginator->sort('name','Suppliers Name'); ?></th>
                	...
                	<tr>
                		...
                		<td><?php echo h($supplier['Supplier']['name']); ?>&nbsp;</td>
                            <td><?php echo h($supplier['Supplier']['contactperson']); ?>&nbsp;</td>
                		...
                		<td class="actions" style="text-align: center;"> 
                			<?php echo $this->Html->link(__('<i class="glyphicon glyphicon-pencil" title="Edit Supplier"></i>'), array('action' => 'edit', $supplier['Supplier']['id']),array('escape' =>false)); ?> 
                		</td>
                	</tr>
                    <?php endforeach; ?>
                </table>
